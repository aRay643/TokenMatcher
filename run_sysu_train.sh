...
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_sysu.py -b 128 -a vit_base -d sysu_all --num-instances 16 --data-dir "/home/lr/code/dataset/VI-ReID/SYSU-MM01" --iters 200 --self-norm --conv-stem \
